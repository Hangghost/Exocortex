...
| web-clip | Clip web articles into Markdown + images for blog reference. Downloads article content, saves as structured Markdown with optional Traditional Chinese translation. Use when user invokes /clip with a URL. | `rules/skills/web-clip/SKILL.md` |
