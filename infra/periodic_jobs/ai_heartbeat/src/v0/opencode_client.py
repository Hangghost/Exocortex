...
# Walk up to project root (v0 → src → ai_heartbeat → periodic_jobs → infra → project_root)
project_env_path = module_dir.parent.parent.parent.parent.parent / ".env"
legacy_env_path = module_dir.parent.parent / ".env"
...
class OpenCodeClient:
    ...
    def send_message(self, session_id, message, model_id="gemini-2.5-flash", provider_id=None, agent="build"):
        try:
